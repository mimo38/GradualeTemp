...
,DIV=30%                       Plus grand => des marges plus petites.
...
\grechangestafflinethickness{10} %%% epaisseur des lignes
...
\textbf{\begin{center}{Séquence de Pâques}\end{center}}
\cantus{Sequence}{VictimaePaschali}{}{}
