...
,fontsize=20pt%                Taille de police.
,DIV=20%                       Plus grand => des marges plus petites.
...
\grechangedim{commentaryraise}{0,5 cm}{scalable}
\grecommentary{{\small \emph{Col 3, 1-4}}}
\grechangedim{manualinitialwidth}{1 cm}{scalable}
\greillumination{\includegraphics[width=2 cm,height=5 cm]{Blasonjeanne.jpeg}}
